...
const moneySignalConfig = {
  ...
  moderate: { label: '사용처 근거 보통', color: '#38bdf8', bg: '#1c2535' },
...
const s: Record<string, React.CSSProperties> = {
  ...
  actionBtn: { background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, padding: '7px 16px', color: '#94a3b8', fontSize: 12, cursor: 'pointer' },
  ...
  officialCard: { background: '#1c2535', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 10, padding: '14px 16px', borderLeft: '3px solid #16a34a' },
  ...
  articleCard: { background: '#1c2535', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 10, padding: 12, textDecoration: 'none', display: 'flex', gap: 12, alignItems: 'stretch', transition: 'border-color 0.15s' },
  ...
  supportArrowBtn: { position: 'absolute', top: '50%', transform: 'translateY(-50%)', zIndex: 1, width: 28, height: 44, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 8, color: '#94a3b8', fontSize: 28, lineHeight: 1, cursor: 'pointer' },
  orgCard: { height: '100%', minHeight: 0, background: '#1c2535', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 10, overflow: 'hidden', display: 'flex', flexDirection: 'column' },
  ...
  modalBox: { background: '#1c2535', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 14, padding: '24px', minWidth: 280, maxWidth: 340, width: '90%' },

...
const s: Record<string, React.CSSProperties> = {
  ...
  decisionCard: { background: '#1c2535', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '18px 22px', boxShadow: '0 18px 50px rgba(0,0,0,0.18)' },
  ...
  timelineDot: { width: 40, height: 40, borderRadius: '50%', background: '#1c2535', border: '2px solid rgba(22,163,74,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, zIndex: 1 },
  timelineLine: { position: 'absolute', left: 19, top: 40, bottom: -24, width: 2, background: 'rgba(22,163,74,0.2)' },
  timelineCard: { flex: 1, background: '#1c2535', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '16px 20px', marginBottom: 24 },
